...
.PowerShell 툴킷
NetApp.ONTAP PowerShell Toolkit을 사용하면 Windows 호스트에서 ONTAP 클러스터 관리를 자동화할 수 있습니다. 자세한 내용은 link:../pstk/learn-about-pstk.html["NetApp ONTAP PowerShell Toolkit에 대해 알아보십시오"]을 참조하십시오.
...
.NetApp Console 자동화 허브
그만큼 https://console.netapp.com/automationHub["NetApp Console 자동화 허브"^] 콘솔 웹 사용자 인터페이스를 통해 사용할 수 있습니다. 자동화 허브는 ONTAP 을 다른 제품과 함께 배포하고 통합하는 과정을 자동화하는 데 도움이 되는 패키지 솔루션에 대한 액세스를 제공합니다. 보다 https://docs.netapp.com/us-en/netapp-automation/["NetApp 자동화"^] 문서 및 자세한 내용은 여기를 참조하세요.
