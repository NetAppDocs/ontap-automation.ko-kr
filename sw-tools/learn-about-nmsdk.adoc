...
NOTE: NetApp Manageability SDK와 OnCommand Workflow Automation 이 계속 지원되는 반면, ONTAP 시스템을 자동화할 때 선호되고 전략적인 기술은 ONTAP REST API입니다. 보다 link:../migrate/migration-considerations.html["ONTAPI에서 REST API로 마이그레이션합니다"] 자세한 내용은.
