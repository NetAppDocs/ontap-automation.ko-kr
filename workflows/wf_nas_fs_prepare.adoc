...
NOTE: ONTAP 9.9.1 이전 릴리스의 경우 CLI 패스스루 기능을 사용하여 SACL 및 DACL 권한 관리를 자동화할 수 있습니다. 자세한 내용은 link:../migrate/migration-considerations.html["ONTAPI에서 REST API로 마이그레이션합니다"]을 참조하십시오.
