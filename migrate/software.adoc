...
NetApp ONTAP PowerShell 툴킷은 2,400개 이상의 cmdlet을 포함하는 모듈로 로컬 PowerShell 환경을 향상시켜 줍니다. 이를 통해 Windows 호스트에서 ONTAP 배포를 자동화하는 코드를 신속하게 개발할 수 있습니다. 자세한 내용은 link:../pstk/learn-about-pstk.html["NetApp ONTAP PowerShell Toolkit에 대해 알아보십시오"]을 참조하십시오.
